...
class ForgotPasswordVerificationPage extends StatefulWidget {
  final String _aadhaarNumber;
  const ForgotPasswordVerificationPage(String aadhaarNumber, {Key? key})
          ...
          child: Column(
            children: [
              Container(
                ...
                child: HeaderWidget(
                    _headerHeight, true, 'assets/images/sehyog_short.png'),
              ),
              SafeArea(
                child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              'on the mobile number linked with your aadhar.',
                              style: TextStyle(
                                  // fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black54),
